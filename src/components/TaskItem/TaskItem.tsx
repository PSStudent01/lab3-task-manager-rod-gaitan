...
return (  //every React component MUST return 'JSX' (the HTML-like code).
  <div className={`task-item status-${task.status}`}>  {/*a wrapper element that wraps everything inside the component*/}
    ...
    <p>{task.description}</p>  {/*displays the 'description' value of 'task' prop (aka 'Task') inside a paragraph. */}
